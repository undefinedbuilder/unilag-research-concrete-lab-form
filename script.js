...
<head>
  ...
  <!-- Force ONE font everywhere (without changing style.css) -->
  <style>
    :root{
...
<body>
  <main class="container">
        ...
        <form id="mix-form">
          ...
          <div class="mix-mode-wrap" role="group" aria-label="Mix input mode">
            <div class="mix-mode-toggle">
              ...
              <label class="mix-mode-pill">
                ...
                <span class="mix-mode-pill-title">Ratios</span>
                <span class="mix-mode-pill-sub">Enter material quantities in ratios</span>
              </label>
            </div>
          </div>
          ...
          <div id="ratioInputs" style="display: none;">
            <div class="grid two">
              ...
              <label>
                <span class="label-line">
                  Water (W/C) <span class="required-asterisk">*</span>
                </span>
          ...
          <div id="mixratio-box" class="wc-box" style="display:none;">
              <strong>Normalized Mix Ratio (by cement):</strong>
    ...
    >
      <div class="modal-card research">
        ...
        <div class="modal-body">
          ...
          <p class="subtle small-note">Your application number has been generated.</p>
        </div>
      </div>
    </div>
    ...
    <footer class="footer">
      <p>
        © <span id="year"></span> University of Lagos – Department of Civil &amp; Environmental Engineering
      </p>
    </footer>
  </main>
</body>
